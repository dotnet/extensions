...
public sealed class TagProviderAttribute : Attribute
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="T:Microsoft.Extensions.Telemetry.Logging.TagProviderAttribute" /> class with custom tags provider.
    /// </summary>
    ...
    /// <list type="number">
    ///   <item>
    ///     <description>First one of <see cref="T:Microsoft.Extensions.Telemetry.Logging.ITagCollector" /> type</description>
    ///   </item>
    ///   <item>
    ///     <description>
    ...
    /// </code>
    /// </example>
    /// <seealso cref="T:Microsoft.Extensions.Telemetry.Logging.ITagCollector" />
