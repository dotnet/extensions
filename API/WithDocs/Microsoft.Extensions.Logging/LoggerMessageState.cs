...
public sealed class LoggerMessageState : IEnrichmentTagCollector, IReadOnlyList<KeyValuePair<string, object?>>, IEnumerable<KeyValuePair<string, object?>>, IEnumerable, IReadOnlyCollection<KeyValuePair<string, object?>>, ITagCollector
{
    ...
    public readonly struct ClassifiedTag
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="T:Microsoft.Extensions.Logging.LoggerMessageState.ClassifiedTag" /> struct.
        /// </summary>
    ...
    /// <see cref="M:Microsoft.Extensions.Logging.ITagCollector.Add(System.String,System.Object)" /> or <see cref="M:Microsoft.Extensions.Logging.ITagCollector.Add(System.String,System.Object,Microsoft.Extensions.Compliance.Classification.DataClassification)" />
    /// methods.
    /// </summary>
    ...
    /// <returns>The index in the <see cref="P:Microsoft.Extensions.Logging.LoggerMessageState.TagArray" /> where to store the tags.</returns>
    ...
    /// </summary>
    /// <param name="count">The amount of space to allocate.</param>
    /// <returns>The index in the <see cref="P:Microsoft.Extensions.Logging.LoggerMessageState.ClassifiedTagArray" /> where to store the classified tags.</returns>
