...
/// <summary>
/// Defines an API <c>OPTIONS</c> method.
/// </summary>
/// <remarks>
/// Marks a method within an interface annotated with <see cref="T:Microsoft.Extensions.Http.AutoClient.AutoClientAttribute" /> as an API <c>OPTIONS</c> method.
///
...
public sealed class OptionsAttribute : Attribute
{
    ...
    /// For example, if the method is called <c>UserOptionsAsync</c>, the request name, by default, will be <c>UserOptions</c>.
    /// </remarks>
    /// <example>
    /// <code>
    /// [AutoClient("MyClient")]
