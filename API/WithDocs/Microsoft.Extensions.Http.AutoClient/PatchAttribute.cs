...
/// <summary>
/// Defines an API <c>PATCH</c> method.
/// </summary>
/// <remarks>
/// Marks a method within an interface annotated with <see cref="T:Microsoft.Extensions.Http.AutoClient.AutoClientAttribute" /> as an API <c>PATCH</c> method.
///
...
public sealed class PatchAttribute : Attribute
{
    ...
    /// For example, if the method is called <c>UpdateUserAsync</c>, the request name, by default, will be <c>UpdateUser</c>.
    /// </remarks>
    /// <example>
    /// <code>
    /// [AutoClient("MyClient")]
