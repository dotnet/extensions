...
/// <summary>
/// Defines an API <c>POST</c> method.
/// </summary>
/// <remarks>
/// Marks a method within an interface annotated with <see cref="T:Microsoft.Extensions.Http.AutoClient.AutoClientAttribute" /> as an API <c>POST</c> method.
///
...
public sealed class PostAttribute : Attribute
{
    ...
    /// For example, if the method is called <c>AddUserAsync</c>, the request name, by default, will be <c>AddUser</c>.
    /// </remarks>
    /// <example>
    /// <code>
    /// [AutoClient("MyClient")]
