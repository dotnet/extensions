...
public class FakeLoggerProvider : ILoggerProvider, IDisposable, ISupportExternalScope
{
    ...
    /// Clean up resources held by this object.
    /// </summary>
    /// <param name="disposing"><see langword="true" /> when called from the <see cref="M:Microsoft.Extensions.Telemetry.Testing.Logging.FakeLoggerProvider.Dispose" /> method, <see langword="false" /> when called from a finalizer.</param>
