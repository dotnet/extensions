...
public class FakeLogRecord
{
    ...
    ///
    /// The object returned by this property is the same as what <see cref="P:Microsoft.Extensions.Telemetry.Testing.Logging.FakeLogRecord.State" /> returns, except it has been cast to a read-only list.
    /// </remarks>
