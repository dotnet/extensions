...
{
    /// <summary>
    /// Initializes a new instance of the <see cref="T:Microsoft.Extensions.Logging.Testing.FakeLogger`1" /> class.
    /// </summary>
    /// <param name="collector">Where to push all log state.</param>
    public FakeLogger(FakeLogCollector? collector = null);

    /// <summary>
    /// Initializes a new instance of the <see cref="T:Microsoft.Extensions.Logging.Testing.FakeLogger`1" /> class that copies all log records to the given output sink.
    /// </summary>
