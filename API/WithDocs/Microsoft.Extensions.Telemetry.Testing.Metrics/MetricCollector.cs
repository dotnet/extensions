...
{
    /// <summary>
    /// Gets the <see cref="P:Microsoft.Extensions.Telemetry.Testing.Metrics.MetricCollector`1.Instrument" /> that is being recorded.
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="T:Microsoft.Extensions.Telemetry.Testing.Metrics.MetricCollector`1" /> class.
    /// </summary>
    ...
    /// <summary>
    /// Disposes the <see cref="T:Microsoft.Extensions.Telemetry.Testing.Metrics.MetricCollector`1" /> and stops recording measurements.
    /// </summary>
    public void Dispose();
