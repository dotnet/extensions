...
try {
    ...
    if ($LastExitCode -ne 0) {
        ...
        LogError "Generated code is not up to date. You might need to regenerate project list or reference assemblies (see docs/ReferenceAssemblies.md and docs/ReferenceResolution.md)"
    }
}
finally {
    Write-Host ""
