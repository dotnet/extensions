...
| `EXTOBS0002` | This API is obsolete and will be removed in a future version. Consider using the respective AddApplicationLogEnricher() method overloads instead. |
