...
namespace Microsoft.Extensions.Internal
{
    public class PropertyHelperTest
    {
        ...
        public void PropertyHelper_ReturnsCachedPropertyHelper()
        {
            ...
            // Act
            var helpers1 = PropertyHelper.GetProperties(anonymous.GetType());
        ...
        public void PropertyHelper_DoesNotChangeUnderscores()
        {
            ...
            // Act + Assert
            var helper = Assert.Single(PropertyHelper.GetProperties(anonymous.GetType()));
        ...
        public void PropertyHelper_WorksForStruct()
        {
            ...
            // Act + Assert
            var helper1 = Assert.Single(PropertyHelper.GetProperties(anonymous.GetType()).Where(prop => prop.Name == "IntProp"));
            var helper2 = Assert.Single(PropertyHelper.GetProperties(anonymous.GetType()).Where(prop => prop.Name == "StringProp"));
        ...
        public void PropertyHelper_ForDerivedClass()
        {
            ...
            // Act
            var helpers = PropertyHelper.GetProperties(derived.GetType()).ToArray();
