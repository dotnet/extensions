...
{
    private const string BaseMeterName = "Microsoft.GeneratedCode.Test.Metering." + nameof(MetricTests) + ".";

    private readonly Meter _meter;
    private readonly FakeMeteringCollector _collector;
    ...
    public MetricTests()
    {
        ...
        _collector = new FakeMeteringCollector(new HashSet<string> { _meterName });
    }
