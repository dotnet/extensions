...
public partial class ParserTests
{
        ...
        bool includeTransitiveReferences = true)
    {
        ...
        {
            assemblies.Add(Assembly.GetAssembly(typeof(Microsoft.Extensions.Options.Validation.ValidateObjectMembersAttribute))!);
        }
