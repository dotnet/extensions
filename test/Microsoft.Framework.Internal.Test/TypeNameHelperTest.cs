...
namespace Microsoft.Framework.Internal
{
    public class TypeNameHelperTest
    {
        ...
        public void Can_pretty_print_CLR_full_name()
        {
            ...
            Assert.Equal("Microsoft.Framework.Internal.TypeNameHelperTest+A",
                TypeNameHelper.GetTypeDisplayName(typeof(A)));
            Assert.Equal("Microsoft.Framework.Internal.TypeNameHelperTest+B<int>",
                TypeNameHelper.GetTypeDisplayName(typeof(B<int>)));
            Assert.Equal("Microsoft.Framework.Internal.TypeNameHelperTest+C<int, string>",
                TypeNameHelper.GetTypeDisplayName(typeof(C<int, string>)));
            Assert.Equal("Microsoft.Framework.Internal.TypeNameHelperTest+C<int, Microsoft.Framework.Internal.TypeNameHelperTest+B<string>>",
                TypeNameHelper.GetTypeDisplayName(typeof(C<int, B<string>>)));
            Assert.Equal("Microsoft.Framework.Internal.TypeNameHelperTest+B<Microsoft.Framework.Internal.TypeNameHelperTest+B<string>>",
                TypeNameHelper.GetTypeDisplayName(typeof(B<B<string>>)));

            // Classes inside Generic class
            Assert.Equal("Microsoft.Framework.Internal.TypeNameHelperTest+Outer<int>+D",
                TypeNameHelper.GetTypeDisplayName(typeof(Outer<int>.D)));
            Assert.Equal("Microsoft.Framework.Internal.TypeNameHelperTest+Outer<int>+E<int>",
                TypeNameHelper.GetTypeDisplayName(typeof(Outer<int>.E<int>)));
            Assert.Equal("Microsoft.Framework.Internal.TypeNameHelperTest+Outer<int>+F<int, string>",
                TypeNameHelper.GetTypeDisplayName(typeof(Outer<int>.F<int, string>)));
            Assert.Equal("Microsoft.Framework.Internal.TypeNameHelperTest+Outer<int>+F<int, Microsoft.Framework.Internal.TypeNameHelperTest+Outer<int>+E<string>>",
                TypeNameHelper.GetTypeDisplayName(typeof(Outer<int>.F<int, Outer<int>.E<string>>)));
            Assert.Equal("Microsoft.Framework.Internal.TypeNameHelperTest+Outer<int>+E<Microsoft.Framework.Internal.TypeNameHelperTest+Outer<int>+E<string>>",
