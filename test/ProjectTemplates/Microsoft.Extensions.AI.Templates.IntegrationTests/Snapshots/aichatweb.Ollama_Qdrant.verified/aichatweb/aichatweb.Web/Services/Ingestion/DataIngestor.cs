    ...
    IVectorStore vectorStore)
{
    ...
    {
        var chunksCollection = vectorStore.GetCollection<Guid, IngestedChunk>("data-aichatweb-chunks");
        var documentsCollection = vectorStore.GetCollection<Guid, IngestedDocument>("data-aichatweb-documents");
