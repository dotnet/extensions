...
public class SpeechToTextMessageTests
{
    ...
    public void Text_GetSet_UsesFirstTextContent()
    {
        ...
        [
            ...
            new DataContent("data:image/png;base64,AQIDBA=="),
    ...
    public void ItCanBeSerializeAndDeserialized()
    {
        ...
        [
            ...
            new DataContent(new Uri("data:audio/wav;base64,AQIDBA=="), "mime-type/2")
            {
        ...
        Assert.Equal("data:mime-type/2;base64,AQIDBA==", dataContent.Uri);
