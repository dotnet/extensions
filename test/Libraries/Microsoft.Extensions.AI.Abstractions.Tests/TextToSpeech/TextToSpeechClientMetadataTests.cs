...
public class TextToSpeechClientMetadataTests
{
    [Fact]
    public void Constructor_NullValues_AllowedAndRoundtrip()
    {
        TextToSpeechClientMetadata metadata = new(null, null, null);
    ...
    public void Constructor_Value_Roundtrips()
    {
        ...
        TextToSpeechClientMetadata metadata = new("providerName", uri, "theModel");
