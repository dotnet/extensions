...
public class HmacRedactorTest
{
    ...
    public void Can_Register_And_Use_HmacRedactor()
    {
        foreach (var example in HmacExamples)
        {
            ...
            var redactor = redactorProvider.GetRedactor(SimpleClassifications.PrivateData);
...
#pragma warning restore S3257 // Declarations and initializations should be as concise as possible
    {
        new()
        {
            ...
            Hash = "101ZLpXObbqe3ct474jNO6qg43jQXEe9KGy2HEcoOWsggI="
        },
        ...
        new()
        {
            ...
            Hash = "101PHsIeg/J+EMUtCpPUkl44hP80OGU0sMIyZFqblgFgFo="
        },
        ...
        new()
        {
            ...
            Hash = "1019IqU4+6v/lJPtBGTCXKHlCkbkqLhzMjrQYCjtViF9cM="
        },
        ...
        new()
        {
            ...
            Hash = "101DPDQhjV9RhaI+s9lHGiPLIrCyBBZdGryZady845zE90="
         },
        ...
        new()
        {
            ...
            Hash = "101MEgoZ3A+OW0sr1tsViar30xyuxYcjtbtx73SDW6waqw="
        },
        ...
        new()
        {
            ...
            Hash = "101DVGwCn9cMalmwXUali2Qy7IOMEk5vmsGi1ZSNS2EzOw="
        },
        ...
        new()
        {
            ...
            Hash = "101xZh9JQhDU587uZ3h2MjbA67Ho7eI8hYKgelO4gKlszA="
        },
        ...
        new()
        {
            ...
            Hash = "101wJZ6IH2M36uXwQKbidfah9ie8AaEGrpq3C0LLoW2xLU="
        },
        ...
        new()
        {
            ...
            Hash = "101qmVBPn9wkELigo8wv7LZi1c2e5lLu/7MtQNYDog1zmE="
        },
        ...
        new()
        {
            ...
            Hash = "101mY7p7yqH47WYZP7CnzGDWjGUcD0OvwRKDxWriHxHkhY="
        },
        ...
        new()
        {
            ...
            Hash = "101xdpuFzstLboWoR7HWkVa+Eo5bqx44l9GagOHLrY87nk="
        },
        ...
        new()
        {
            ...
            Hash = "101c0Rvtx8+ySk5uzx3+mf4v6fSKMqcFQWFaZfYGXrbzu0="
        },
        ...
        new()
        {
            ...
            Hash = "101yo4N1fVW166ujJIOxwx+WPdhr0lxpJNcDDyluCt0+AY="
        },
        ...
        new()
        {
            ...
            Hash = "101lmEDgf/hE8p4yYSnKCTa+ZkjdYEj4f4aovBdoWDvT8Q="
        },
        ...
        new()
        {
            ...
            Hash = "101Yfo37VRC9GWUMkqG57HgqBG5jMUbAwcok2/QjfakVHg="
        },
        ...
        new()
        {
            ...
            Hash = "101SOP5zMpCSRn9N9/Y3/KPxsfmivTBTsJjSyhr/rcRBOQ="
        }
    };
