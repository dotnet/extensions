...
#pragma warning disable S3459 // Remove unassigned auto-property
    private sealed class NrtTestRecord
    {
        public required string NonNullableString { get; set; }
        public string? NullableString { get; set; }
        public required byte[] NonNullableByteArray { get; set; }
