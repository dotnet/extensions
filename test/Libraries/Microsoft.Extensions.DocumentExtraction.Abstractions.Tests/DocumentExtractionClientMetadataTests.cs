...
public class DocumentExtractionClientMetadataTests
{
    [Fact]
    public void Constructor_NullValues_AllowedAndRoundtrip()
    {
        DocumentExtractionClientMetadata metadata = new(null, null, null);
    ...
    public void Constructor_Value_Roundtrips()
    {
        ...
        DocumentExtractionClientMetadata metadata = new("providerName", uri, "theModel");
