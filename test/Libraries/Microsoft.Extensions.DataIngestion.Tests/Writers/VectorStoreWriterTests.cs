...
public abstract class VectorStoreWriterTests
{
    ...
    public async Task CanWriteChunksWithCustomDefinition()
    {
        ...
        VectorStoreCollectionDefinition definition = new()
        {
            Properties =
            {
                ...
                new VectorStoreVectorProperty(nameof(IngestionChunkVectorRecord.Embedding), typeof(AIContent), TestEmbeddingGenerator<AIContent>.DimensionCount)
                {
    ...
    public async Task CanWriteChunksWithMetadata()
    {
        ...
        VectorStoreCollection<Guid, TestChunkRecordWithMetadata> collection = vectorStore.GetCollection<Guid, TestChunkRecordWithMetadata>("chunks-meta");
