...
public abstract class DocumentReaderConformanceTests
{
    ...
    [ConditionalFact]
    public virtual Task SupportsImages()
        => SupportsImagesCore(Path.Combine("TestFiles", "SampleWithImage.pdf"));

    protected async Task SupportsImagesCore(string filePath)
    {
        FileInfo source = new(filePath);
