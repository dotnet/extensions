...
public class LatencyDataTest
{
    ...
    public void LatencyData_BasicTest()
    {
        ...
        ArraySegment<Checkpoint> checkpoints = new ArraySegment<Checkpoint>(LatencyDataTest.GetCheckpoints(num));
    ...
    public void LatencyData_SegmentTest()
    {
        ...
        ArraySegment<Checkpoint> checkpoints = new ArraySegment<Checkpoint>(LatencyDataTest.GetCheckpoints(num), 1, numCheckpoints);
