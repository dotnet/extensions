...
public class CircuitBreakerPolicyOptionsTests
{
    private readonly CircuitBreakerPolicyOptions<string> _testClass;

    public CircuitBreakerPolicyOptionsTests()
    {
        _testClass = new CircuitBreakerPolicyOptions<string>();
    }

    [Fact]
    public void Constructor_ShouldInitialize()
    {
        var instance = new CircuitBreakerPolicyOptions<string>();
    ...
    {
        Action<BreakActionArguments<string>> testValue = _ => { };
