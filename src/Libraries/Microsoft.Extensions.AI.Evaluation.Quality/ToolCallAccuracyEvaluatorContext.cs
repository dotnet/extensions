...
/// defined as <see cref="AIFunctionDefinition"/>s. Any other <see cref="AITool"/> definitions that are supplied via
...
public sealed class ToolCallAccuracyEvaluatorContext : EvaluationContext
{
    ...
    /// are defined as <see cref="AIFunctionDefinition"/>s. Any other <see cref="AITool"/> definitions will be ignored.
    /// </para>
    /// </param>
    ...
    /// <para>
    /// Note that at the moment, <see cref="ToolCallAccuracyEvaluator"/> only supports evaluating calls to tools that
    /// are defined as <see cref="AIFunctionDefinition"/>s. Any other <see cref="AITool"/> definitions that are supplied via
    /// <see cref="ToolDefinitions"/> will be ignored.
    /// </para>
    /// </remarks>
