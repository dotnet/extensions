...
/// <summary>Provides extensions for configuring <see cref="LoggingVideoGenerator"/> instances.</summary>
[Experimental(DiagnosticIds.Experiments.AIVideoGeneration, UrlFormat = DiagnosticIds.UrlFormat)]
public static class LoggingVideoGeneratorBuilderExtensions
{
    /// <summary>Adds logging to the video generator pipeline.</summary>
    ...
    /// </param>
    /// <param name="configure">An optional callback that can be used to configure the <see cref="LoggingVideoGenerator"/> instance.</param>
    ...
    /// </para>
    /// </remarks>
    public static VideoGeneratorBuilder UseLogging(
        this VideoGeneratorBuilder builder,
        ILoggerFactory? loggerFactory = null,
        Action<LoggingVideoGenerator>? configure = null)
    {
        ...
        return builder.Use((innerGenerator, services) =>
        {
            ...
            // If the factory we resolve is for the null logger, the LoggingVideoGenerator will end up
            ...
            var videoGenerator = new LoggingVideoGenerator(innerGenerator, loggerFactory.CreateLogger(typeof(LoggingVideoGenerator)));
            configure?.Invoke(videoGenerator);
