...
public sealed class OpenTelemetryOcrClient : DelegatingOcrClient
{
    ...
    /// <summary>Initializes a new instance of the <see cref="OpenTelemetryOcrClient"/> class.</summary>
    ...
    public OpenTelemetryOcrClient(IOcrClient innerClient, ILogger? logger = null, string? sourceName = null)
        : base(innerClient)
    {
        ...
        if (innerClient!.GetService<OcrClientMetadata>() is OcrClientMetadata metadata)
        {
    ...
    private Activity? CreateAndConfigureActivity(OcrOptions? options)
    {
