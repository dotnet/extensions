...
/// <summary>Provides extensions for configuring <see cref="LoggingOcrClient"/> instances.</summary>
[Experimental(DiagnosticIds.Experiments.AIOcr, UrlFormat = DiagnosticIds.UrlFormat)]
public static class LoggingOcrClientBuilderExtensions
{
    ...
    /// </param>
    /// <param name="configure">An optional callback that can be used to configure the <see cref="LoggingOcrClient"/> instance.</param>
    ...
    /// </para>
    /// </remarks>
    public static OcrClientBuilder UseLogging(
        this OcrClientBuilder builder,
        ILoggerFactory? loggerFactory = null,
        Action<LoggingOcrClient>? configure = null)
    {
        ...
        return builder.Use((innerClient, services) =>
        {
            ...
            // If the factory we resolve is for the null logger, the LoggingOcrClient will end up
            ...
            var ocrClient = new LoggingOcrClient(innerClient, loggerFactory.CreateLogger(typeof(LoggingOcrClient)));
            configure?.Invoke(ocrClient);
            return ocrClient;
        });
    }
}
