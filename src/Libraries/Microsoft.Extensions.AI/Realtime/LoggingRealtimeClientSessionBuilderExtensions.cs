...
/// <summary>Provides extensions for configuring <see cref="LoggingRealtimeClientSession"/> instances.</summary>
[Experimental("MEAI001")]
public static class LoggingRealtimeClientSessionBuilderExtensions
{
    ...
    /// </param>
    /// <param name="configure">An optional callback that can be used to configure the <see cref="LoggingRealtimeClientSession"/> instance.</param>
    ...
    /// </para>
    /// </remarks>
    public static RealtimeClientSessionBuilder UseLogging(
        this RealtimeClientSessionBuilder builder,
        ILoggerFactory? loggerFactory = null,
        Action<LoggingRealtimeClientSession>? configure = null)
    {
        ...
        return builder.Use((innerSession, services) =>
        {
            ...
            // If the factory we resolve is for the null logger, the LoggingRealtimeClientSession will end up
            ...
            var session = new LoggingRealtimeClientSession(innerSession, loggerFactory.CreateLogger(typeof(LoggingRealtimeClientSession)));
