...
public static class ChatClientStructuredOutputExtensions
{
    ...
    /// <summary>Sends a chat message to the model, requesting a response matching the type <typeparamref name="T"/>.</summary>
    /// <param name="chatClient">The <see cref="IChatClient"/>.</param>
    ...
    public static Task<ChatCompletion<T>> CompleteAsync<T>(
        ...
        bool? useNativeJsonSchema = null,
        CancellationToken cancellationToken = default) =>
        CompleteAsync<T>(chatClient, [chatMessage], options, useNativeJsonSchema, cancellationToken);
    ...
    public static Task<ChatCompletion<T>> CompleteAsync<T>(
        ...
        bool? useNativeJsonSchema = null,
        CancellationToken cancellationToken = default) =>
        CompleteAsync<T>(chatClient, [chatMessage], serializerOptions, options, useNativeJsonSchema, cancellationToken);
