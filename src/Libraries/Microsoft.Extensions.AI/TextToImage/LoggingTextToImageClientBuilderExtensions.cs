...
/// <summary>Provides extensions for configuring <see cref="LoggingTextToImageClient"/> instances.</summary>
[Experimental("MEAI001")]
public static class LoggingTextToImageClientBuilderExtensions
{
    ...
    /// </para>
    /// </remarks>
    public static TextToImageClientBuilder UseLogging(
        this TextToImageClientBuilder builder,
        ILoggerFactory? loggerFactory = null,
        Action<LoggingTextToImageClient>? configure = null)
    {
        ...
        return builder.Use((innerClient, services) =>
        {
            ...
            // If the factory we resolve is for the null logger, the LoggingTextToImageClient will end up
            ...
            var textToImageClient = new LoggingTextToImageClient(innerClient, loggerFactory.CreateLogger(typeof(LoggingTextToImageClient)));
            configure?.Invoke(textToImageClient);
