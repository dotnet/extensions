...
public partial class LoggerMessageState : ITagCollector
{
    ...
    /// <inheritdoc />
    void ITagCollector.Add(string tagName, object? tagValue, IReadOnlyList<DataClassification> classificationSet)
    {
        string fullName = TagNamePrefix.Length > 0 ? TagNamePrefix + Separator + tagName : tagName;
    ...
    /// <see cref="ITagCollector.Add(string, object?)"/> or <see cref="ITagCollector.Add(string, object?, IReadOnlyList{DataClassification})"/>
    /// methods.
    /// </summary>
