...
public partial class LoggerMessageState
{
    ...
    public readonly struct ClassifiedTag
    {
        ...
        /// </summary>
        public readonly IReadOnlyList<DataClassification> ClassificationsSet { get; }

        /// <summary>
        /// Initializes a new instance of the <see cref="ClassifiedTag"/> struct.
        /// </summary>
        public ClassifiedTag(string name, object? value, IReadOnlyList<DataClassification> classificationsSet)
        {
            Name = name;
            Value = value;
