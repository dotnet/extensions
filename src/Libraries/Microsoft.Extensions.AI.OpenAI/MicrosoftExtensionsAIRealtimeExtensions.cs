...
{
    /// <summary>Creates an OpenAI <see cref="ConversationFunctionTool"/> from an <see cref="AIFunctionDefinition"/>.</summary>
    ...
    public static ConversationFunctionTool AsOpenAIConversationFunctionTool(this AIFunctionDefinition function) =>
