...
public static class OpenAIClientExtensions
{
    ...
    /// <summary>Extracts from an <see cref="AIFunctionDefinition"/> the parameters and strictness setting for use with OpenAI's APIs.</summary>
    internal static BinaryData ToOpenAIFunctionParameters(AIFunctionDefinition aiFunction, bool? strict)
    {
