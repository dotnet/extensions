...
{
    /// <summary>Creates an OpenAI <see cref="ResponseTool"/> from an <see cref="AIFunctionDefinition"/>.</summary>
    /// <param name="function">The function to convert.</param>
    /// <returns>An OpenAI <see cref="ResponseTool"/> representing <paramref name="function"/>.</returns>
    /// <exception cref="ArgumentNullException"><paramref name="function"/> is <see langword="null"/>.</exception>
    public static ResponseTool AsOpenAIResponseTool(this AIFunctionDefinition function) =>
