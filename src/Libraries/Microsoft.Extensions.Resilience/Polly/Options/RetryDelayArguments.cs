...
public readonly struct RetryDelayArguments<TResult> : IPolicyEventArguments<TResult>
#pragma warning restore CA1815
{
    /// <summary>
    /// Initializes a new instance of the <see cref="RetryDelayArguments{TResult}" /> structure.
    /// </summary>
    /// <param name="result">The result.</param>
    /// <param name="context">The policy context.</param>
    /// <param name="cancellationToken">The cancellation token.</param>
    public RetryDelayArguments(
