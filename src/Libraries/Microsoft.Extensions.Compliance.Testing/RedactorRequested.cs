...
public readonly struct RedactorRequested : IEquatable<RedactorRequested>
{
    ...
    /// <returns><see langword="true" /> if object instances are equal <see langword="false" /> otherwise.</returns>
    public bool Equals(RedactorRequested other) => other.SequenceNumber == SequenceNumber && other.DataClassification == DataClassification && other.DataClassifications == DataClassifications;
