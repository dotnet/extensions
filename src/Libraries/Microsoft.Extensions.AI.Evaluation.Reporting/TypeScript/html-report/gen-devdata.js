...
const answerCases = [
    ...
    { id: 'refund-defective-headphones-027', tag: 'difficulty:medium', q: 0.3,
        ...
        answer: 'The standard refund window is 30 days, so a refund isn’t available at 40 days. However defective items are covered by a 12-month warranty for repair or replacement. [[1]]',
    ...
    { id: 'webhook-retry-backoff-101', tag: 'difficulty:medium', q: 0.45,
        ...
        answer: 'Failed webhooks are retried with exponential backoff for up to 24 hours, then moved to a dead-letter queue you can replay from the dashboard. [[1]]',
