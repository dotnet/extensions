...
{
    /// <summary>Sends speech audio contents to the model and returns the generated text.</summary>
    /// <param name="speechContents">The list of speech audio contents to send.</param>
    ...
    /// <summary>Sends speech audio contents to the model and streams back the generated text.</summary>
    /// <param name="speechContents">The list of speech audio contents to send.</param>
    /// <param name="options">The speech to text options to configure the request.</param>
    /// <param name="cancellationToken">The <see cref="CancellationToken"/> to monitor for cancellation requests. The default is <see cref="CancellationToken.None"/>.</param>
