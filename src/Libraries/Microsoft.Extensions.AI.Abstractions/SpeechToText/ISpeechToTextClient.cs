...
/// The audio stream passed to these methods will not be closed or disposed by the implementation.
/// </para>
/// </remarks>
[Experimental("MEAI001")]
public interface ISpeechToTextClient : IDisposable
{
    /// <summary>Sends speech audio content to the model and returns the generated text.</summary>
    ...
    /// <summary>Sends speech audio content to the model and streams back the generated text.</summary>
    /// <param name="audioStream">The audio stream to send.</param>
    /// <param name="options">The speech to text options to configure the request.</param>
    /// <param name="cancellationToken">The <see cref="CancellationToken"/> to monitor for cancellation requests. The default is <see cref="CancellationToken.None"/>.</param>
