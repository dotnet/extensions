...
public abstract class AIFunction : AIFunctionDefinition
{
    ...
    /// <summary>Creates a <see cref="AIFunctionDefinition"/> representation of this <see cref="AIFunction"/> that can't be invoked.</summary>
    /// <returns>The created instance.</returns>
    public AIFunctionDefinition AsDefinitionOnly() => new NonInvocableAIFunction(this);

    private sealed class NonInvocableAIFunction(AIFunction function) : DelegatingAIFunctionDefinition(function);
}
