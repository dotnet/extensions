...
public abstract class AIFunctionDefinition : AITool
{
    /// <summary>Initializes a new instance of the <see cref="AIFunctionDefinition"/> class.</summary>
    protected AIFunctionDefinition()
    {
    }
