...
public sealed class AIFunctionFactoryOptions
{
    ...
    /// <summary>
    /// Gets or sets a value indicating whether a schema should be created for the function's result type, if possible, and included as <see cref="AIFunctionDefinition.ReturnJsonSchema" />.
    /// </summary>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// <para>
    /// When set to <see langword="true"/>, results in the produced <see cref="AIFunctionDefinition.ReturnJsonSchema"/> to always be <see langword="null"/>.
    /// </para>
    /// </remarks>
