...
public interface IOcrClient : IDisposable
{
    ...
    /// <param name="progress">
    /// An optional progress reporter. Engines that poll a long-running operation (such as Azure Document
    /// Intelligence) can report page-by-page progress; synchronous engines report once. Keeping the call
    /// unary while exposing <see cref="IProgress{T}"/> provides observability without modeling a batch
