...
public static class VideoGeneratorExtensions
{
    ...
    public static Task<VideoGenerationResponse> GenerateVideosAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return generator.GenerateAsync(new VideoGenerationRequest(prompt), options, progress, cancellationToken);
    }

    /// <summary>
    /// Generates or edits videos using original media and a text prompt.
    /// </summary>
    /// <param name="generator">The video generator.</param>
    ...
    /// <returns>The videos generated by the generator.</returns>
    public static Task<VideoGenerationResponse> EditVideosAsync(
        this IVideoGenerator generator,
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return generator.GenerateAsync(new VideoGenerationRequest(prompt, originalMedia), options, progress, cancellationToken);
    }

    /// <summary>
    /// Generates or edits a video using the original video and the specified prompt.
    /// </summary>
    /// <param name="generator">The video generator.</param>
    ...
    /// <returns>The videos generated by the generator.</returns>
    public static Task<VideoGenerationResponse> EditVideoAsync(
        this IVideoGenerator generator,
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return generator.GenerateAsync(new VideoGenerationRequest(prompt, [originalVideo]), options, progress, cancellationToken);
    }

    /// <summary>
    /// Generates or edits a video using video data provided as a byte array and the specified prompt.
    /// </summary>
    /// <param name="generator">The video generator.</param>
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return generator.GenerateAsync(new VideoGenerationRequest(prompt, [dataContent]), options, progress, cancellationToken);
    }
    ...
    {
        return MediaTypeMap.GetMediaType(fileName) ?? "video/mp4"; // Default to MP4 if unknown extension
    }
}
