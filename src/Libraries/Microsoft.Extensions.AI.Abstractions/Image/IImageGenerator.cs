...
public interface IImageGenerator : IDisposable
{
    ...
    Task<ImageGenerationResponse> GenerateImagesAsync(ImageGenerationRequest request, ImageGenerationOptions? options = null, CancellationToken cancellationToken = default);
