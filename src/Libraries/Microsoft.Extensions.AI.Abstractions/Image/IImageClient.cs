...
public interface IImageClient : IDisposable
{
    ...
    IAsyncEnumerable<ImageResponseUpdate> GenerateStreamingImagesAsync(ImageRequest request, ImageOptions? options = null, CancellationToken cancellationToken = default);
