...
public sealed class IngestionChunk<T>
{
    ...
    public IngestionChunk(T content, IngestionDocument document, string? context = null)
        : this(content, document, context, tokenCount: 0)
    {
    }
    ...
    /// </exception>
    public IngestionChunk(T content, IngestionDocument document, string? context, int tokenCount)
    {
    ...
    /// <summary>
    /// Gets the number of tokens in the chunk.
    /// </summary>
