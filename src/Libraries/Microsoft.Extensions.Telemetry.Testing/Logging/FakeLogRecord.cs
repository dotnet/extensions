...
#pragma warning restore S107 // Methods should not have too many parameters
    ...
    /// a single state object which is delivered to the <see cref="ILogger.Log"/>
    /// method. This state can be retrieved as a set of name/value pairs encoded in a read-only list.
    ///
    /// The object returned by this property is the same as what <see cref="State"/> returns, except it has been cast to a
    /// read-only list.
    /// </remarks>
    /// <exception cref="InvalidCastException">If the state object was not generated by the R9 logging model and is not a read-only list.</exception>
