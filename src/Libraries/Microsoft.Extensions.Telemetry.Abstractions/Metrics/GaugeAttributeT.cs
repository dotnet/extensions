...
/// </summary>
/// <typeparam name="T">
/// The type of value the gauge will hold, which is limited to <see cref="byte"/>, <see cref="short"/>, <see cref="int"/>, <see cref="long"/>,
...
{
    /// <summary>
    /// Initializes a new instance of the <see cref="GaugeAttribute{T}"/> class.
    /// </summary>
    ...
    /// the metric name would be <c>MemoryGauge</c> if <c>Name</c> wasn't provided.
    /// <code language="csharp">
    /// static partial class Metric
    /// {
