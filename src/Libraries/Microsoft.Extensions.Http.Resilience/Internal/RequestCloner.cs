...
/// <summary>
/// Default implementation of <see cref="IRequestCloner"/> interface for cloning requests.
/// </summary>
/// <remarks>
...
/// </remarks>
internal sealed class RequestCloner : IRequestCloner
{
    ...
    private sealed class Snapshot : IHttpRequestMessageSnapshot
    {
        ...
        public Snapshot(HttpRequestMessage request)
        {
            ...
            {
                Throw.InvalidOperationException($"{nameof(StreamContent)} content cannot by cloned using the {nameof(RequestCloner)}.");
            }
