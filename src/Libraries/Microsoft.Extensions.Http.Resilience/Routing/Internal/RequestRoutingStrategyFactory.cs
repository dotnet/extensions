...
internal abstract class RequestRoutingStrategyFactory<T, TOptions> : IRequestRoutingStrategyFactory
    where T : class, IRequestRoutingStrategy, IResettable
{
    private readonly ObjectPool<T> _pool;
    private TOptions _options;

    protected RequestRoutingStrategyFactory(string clientId, ObjectPool<T> pool, IOptionsMonitor<TOptions> optionsMonitor)
    {
        _pool = pool;
