...
#pragma warning disable CA1062 // In externally visible method, validate parameter is non-null before using it
...
public static class VectorDataStrings
{
    ...
    {
#if NET
        var i = type.Name.IndexOf('`', StringComparison.Ordinal);
#else
