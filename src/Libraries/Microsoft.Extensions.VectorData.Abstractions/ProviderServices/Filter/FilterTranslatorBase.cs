...
#pragma warning restore S1871 // Two branches in a conditional structure should not have exactly the same implementation
    ...
    /// <summary>
    /// Gets the collection model for the current translation operation.
    /// </summary>
    protected CollectionModel Model { get; private set; } = null!;

    /// <summary>
    /// Gets the parameter expression representing the record in the filter lambda.
    /// </summary>
    ...
    {
        _ = Throw.IfNull(lambdaExpression);
        ...
        protected override Expression VisitMember(MemberExpression node)
        {
            ...
            switch (visited.Expression)
            {
                ...
                case QueryParameterExpression p:
                    ...
                    _ = _parameterNames!.Remove(p.Name);
                    break;
