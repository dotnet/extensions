...
{
    /// <summary>
    /// Sets the blotting redactor to use for a set of data classes.
    /// </summary>
    ...
    public static IRedactionBuilder SetBlottingRedactor(this IRedactionBuilder builder, Action<BlottingRedactorOptions> configure, params DataClassification[] classifications)
    {
        ...
        _ = builder
                .Services
                .AddOptions<BlottingRedactorOptions>()
                .Configure(configure);

        return builder.SetRedactor<BlottingRedactor>(classifications);
    }
    ...
    public static IRedactionBuilder SetBlottingRedactor(this IRedactionBuilder builder, IConfigurationSection section, params DataClassification[] classifications)
    {
        _ = Throw.IfNull(builder);
        ...
        _ = builder
                .Services.AddOptions<BlottingRedactorOptions>()
                .Services.Configure<BlottingRedactorOptions>(section);
