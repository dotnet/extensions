...
internal static partial class Log
{
    ...
    /// </summary>
    [LoggerMessage(0, LogLevel.Information, "Configured EventCounters options: {value}")]
    ...
    /// </summary>
    [LoggerMessage(1, LogLevel.Information, "Enabling event source: {name}")]
    ...
    /// </summary>
    [LoggerMessage(2, LogLevel.Warning, "Invalid value {value} resulting in overflow exception during conversion")]
    ...
    /// </summary>
    [LoggerMessage(3, LogLevel.Warning, "Invalid value {value} resulting in Format exception during conversion")]
    ...
    /// </summary>
    [LoggerMessage(4, LogLevel.Debug, "Event name is null, eventSource {name}")]
    ...
    /// </summary>
    [LoggerMessage(5, LogLevel.Debug, "Payload is null for event {eventSourceName}:{eventName}")]
    ...
    /// </summary>
    [LoggerMessage(6, LogLevel.Debug, "EventName: `{eventName}` is not `EventCounters`")]
    ...
    /// </summary>
    [LoggerMessage(7, LogLevel.Debug, "No counters registered for eventSource: {eventSourceName}")]
    ...
    /// </summary>
    [LoggerMessage(8, LogLevel.Trace, "Event payload for event {eventSourceName}:{eventName} does not contain `CounterType`")]
    ...
    /// </summary>
    [LoggerMessage(9, LogLevel.Trace, "Event payload for event {eventSourceName}:{eventName} does not contain `Name`")]
    ...
    /// </summary>
    [LoggerMessage(10, LogLevel.Trace, "Counter name is empty for event {eventSourceName}:{eventName}")]
    ...
    /// </summary>
    [LoggerMessage(11, LogLevel.Trace, "Counter `{counterName}` for eventSource {eventSourceName}:{eventName} not enabled")]
    ...
    /// </summary>
    [LoggerMessage(12, LogLevel.Trace, "Received event {eventSourceName}:{counterName} of type {type}")]
