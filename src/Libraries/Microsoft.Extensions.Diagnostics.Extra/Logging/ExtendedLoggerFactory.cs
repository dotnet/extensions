...
#pragma warning restore CA1031
    ...
    private LoggerConfig ComputeConfig(LoggerEnrichmentOptions? enrichmentOptions, LoggerRedactionOptions? redactionOptions)
    {
        ...
        if (redactionOptions == null)
        {
            ...
            {
                ApplySalt = Config.AddRedactionSalt,
                IncludeDayOfYearInSalt = Config.IncludeDayOfYearInRedactionSalt
            };
        }
        ...
        return new(_staticTags,
                ...
                _redactorProvider,
                redactionOptions.ApplySalt,
                redactionOptions.IncludeDayOfYearInSalt);
    }
