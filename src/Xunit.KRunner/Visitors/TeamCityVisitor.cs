...
namespace Xunit.ConsoleClient
{
    public class TeamCityVisitor : XmlTestExecutionVisitor
    {
        ...
        public TeamCityVisitor(Func<bool> cancelThunk)
            : this(cancelThunk, _ => Guid.NewGuid().ToString("N")) { }

        public TeamCityVisitor(Func<bool> cancelThunk, Func<string, string> flowIdMapper)
            : base(cancelThunk)
        {
