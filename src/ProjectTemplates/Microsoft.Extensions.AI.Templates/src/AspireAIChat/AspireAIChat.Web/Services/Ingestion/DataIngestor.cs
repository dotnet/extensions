...
namespace AspireAIChat.Web.Services.Ingestion;
    ...
    IngestionCacheDbContext ingestionCacheDb)
{
    ...
    {
        var vectorCollection = vectorStore.GetCollection<string, SemanticSearchRecord>("data-AspireAIChat.Web-ingested");
