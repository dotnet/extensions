...
namespace ChatWithCustomData.Aspire_CSharp.Web.Services;
    ...
    IVectorStore vectorStore)
{
    public async Task<IReadOnlyList<SemanticSearchRecord>> SearchAsync(string text, string? filenameFilter, int maxResults)
    {
        ...
        var vectorCollection = vectorStore.GetCollection<Guid, SemanticSearchRecord>("data-ChatWithCustomData.Aspire-CSharp-ingestion");
