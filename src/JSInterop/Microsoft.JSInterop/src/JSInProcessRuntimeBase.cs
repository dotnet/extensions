...
namespace Microsoft.JSInterop
{
    ...
    public abstract class JSInProcessRuntimeBase : JSRuntimeBase, IJSInProcessRuntime
    {
        ...
        {
            var resultJson = InvokeJS(identifier, JsonSerializer.ToString(args, JsonSerializerOptions));
            if (resultJson is null)
            {
                return default;
            }

            return JsonSerializer.Parse<TValue>(resultJson, JsonSerializerOptions);
        }
