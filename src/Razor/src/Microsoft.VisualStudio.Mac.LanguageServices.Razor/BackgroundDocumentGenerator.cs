...
namespace Microsoft.CodeAnalysis.Razor
{
    ...
    internal class BackgroundDocumentGenerator : ProjectSnapshotChangeTrigger
    {
        ...
        private readonly RazorDynamicDocumentInfoProvider _infoProvider;
        private ProjectSnapshotManagerBase _projectManager;
        private Timer _timer;

        [ImportingConstructor]
        public BackgroundDocumentGenerator(ForegroundDispatcher foregroundDispatcher, RazorDynamicDocumentInfoProvider infoProvider)
        {
